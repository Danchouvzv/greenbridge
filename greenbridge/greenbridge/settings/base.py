"""
Base settings for the GreenBridge project.
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': os.environ.get('SECRET_KEY', 'default-secret-key-for-dev'),
    'VERIFYING_KEY': None,
...
# Security settings (common for all environments)
